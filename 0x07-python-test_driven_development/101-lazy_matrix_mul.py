#!/usr/bin/python3
"""Matrix multiplication module by using Numpy"""
...
def lazy_matrix_mul(m_a, m_b):
    ...
    Raises:
        ...
        ValueError: If `m_a` or `m_b` is empty, or if the number of
        columns in `m_a` is not equal to the number of rows in `m_b`.
